            ...
            <tbody>
                @foreach ($presences as $presence)
                    <tr>
                        ...
                        <td data-format="date">{{ $presence->date }}</td>
                        <td class="actions">
                            <a href="{{ route('presences.view', $presence->date) }}"><img src="./assets/images/view.svg" alt="edit" class="action-view"></a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
